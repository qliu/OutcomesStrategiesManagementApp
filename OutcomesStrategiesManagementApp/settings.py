# Django settings for OutcomesStrategiesManagementApp project.
...
# Root URLs of Outcomes&Strategies Management App
...
#ROOT_URL = 'outcomesandstrategiesmanagement'
#APP_SERVER_URL = '/outcomesandstrategiesmanagement'
## <- use this for SERVER

LOGIN_URL = '%s/outcomesandstrategiesmanagement/login/' % APP_SERVER_URL
...
SECRET_KEY = '&amp;j^*2-on9247)54w%8)q%7z%=nkwo^joel3e9qek17n4$03b=-'
...
ROOT_URLCONF = 'OutcomesStrategiesManagementApp.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'OutcomesStrategiesManagementApp.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'outcomesandstrategiesmanagement@gmail.com'
EMAIL_HOST_PASSWORD = 'oasmpiton'